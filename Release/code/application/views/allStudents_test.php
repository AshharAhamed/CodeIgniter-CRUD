                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo anchor("update_ctrl/show_student_id", 'Update', ['class' => 'btn btn-success']); ?>
                                    </td>
                                    <td><a href="<?php echo base_url(); ?> index.php/update_ctrl/show_student_id/<?php echo  $row->StdId; ?>">Edit</a></td>
                                </tr>
                                <?php }?>
                            </tbody>
                            <tfoot>
